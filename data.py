...
def load_dir(partition, test_poison, poison_test_index):
    DATA_DIR = 'E:\\frequency_MN40_data'
    ...
    if partition == 'test' and test_poison == True:
        paths = np.array(paths)  # [poison_test_index]
    return paths
...
class ModelNet40(Dataset):
    def __init__(self, num_points, test_poison, test_poison_target,target_num, model, GFT_noise, partition='train'):
        ...
        self.paths = load_dir(partition, test_poison, self.poison_test_index)
