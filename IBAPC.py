...
def test_poison_opt2(args, io):
    ...
    GFT_noise = np.load('pretrained-results\\GFT_noise epoc249,plb0,phb0,pls1024,phs1024,a_lr0.01, inl0.1, fpTrue, pr0.05, wb0.5,wa0.5,pwa0.9,pwd0.1.npy')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default='pretrained-results\\epoc249 model.t7', metavar='N',
